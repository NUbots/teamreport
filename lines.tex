...
This year the algorithm used in previous years to detect field lines and corners \cite{NUBOT2006,NUManoids2008} was built upon. The detection algorithm is almost the same as the previous years, other then few modifications required to scan the larger image. Further development this year involved improvements to the corner selection, penalty spot detection and centre circle detection for use in Localization. Calibration of the cameras were also included to improve the estimation of distances. 
